...
Stable comparison results are generated by `zig build bench-compare -- --profile stable`. The benchmark workflow matches zhtml; zxml DOM timing keeps input/setup outside the timed region and reuses parser-owned capacity between parses.
